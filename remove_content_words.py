import argparse
import os
os.environ["CORENLP_HOME"] = '/cluster/home/gboeshertz/stanza_corenlp/'
...
def mask_out_content(text, model, client, debug=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--model", help="sentence transformer model",default="all-mpnet-base-v2")
    ...
    #print(df[args.article_col_name][0])
    #text = mask_out_content(df[args.article_col_name][0], model, client, debug=True)
    #print('TEXT IS ', text)
